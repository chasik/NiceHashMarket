...
using NiceHashMarket.YiiMiningPool;
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            wallet.NewBlockIdFounded += (sender, newBlockId) =>
            {
                ...
                .ContinueWith(t =>
                    {
                        ITransaction r = wallet.RewardTransaction(t.Result);

                        System.Console.WriteLine(
                            $"{currentDateTime:T} \t\t {newBlockId} {t.Result.Created:T} \t {(currentDateTime - t.Result.Created).TotalSeconds} \t {t.Result.Difficulty} \t {t.Result.RewardTransaction.Outputs.First().Address}");
                    });
            };
        ...
        static void Main95977777777(string[] args)
        {
            try
            {
