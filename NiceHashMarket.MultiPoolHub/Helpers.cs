...
namespace NiceHashMarket.MultiPoolHub
{
    public static class Helpers
    {
        ...
        public static string GenerateMerkleRoot(string Coinb1, string Coinb2, string ExtraNonce1, string ExtraNonce2, string[] MerkleNumbers)
        {
            ...
            var hashValue2 = mySHA256.ComputeHash(hashValue);
            ...
            var merkleRoot = ByteArrayToHexString(ReverseByteArrayByFours(hashValue2));
        ...
        public static string GenerateTarget(int Difficulty)
        {
            ...
            var Target = ByteArrayToHexString(result);
